...
class plgcgisotopeisoInstallerScript
{
	...
	private $name                    = 'Plugin CGIsotope Iso';
	...
	private function postinstall_cleanup() {
		...
		{
			$f = JPATH_SITE . '/plugins/plg_cgisotope_'.$this->extname.'/' . $folder;
		...
		$langFiles = [
			sprintf("%s/language/en-GB/en-GB.plg_cgisotope_%s.ini", JPATH_ADMINISTRATOR, $this->extname),
			sprintf("%s/language/en-GB/en-GB.plg_cgisotope_%s.sys.ini", JPATH_ADMINISTRATOR, $this->extname),
			sprintf("%s/language/fr-FR/fr-FR.plg_cgisotope_%s.ini", JPATH_ADMINISTRATOR, $this->extname),
			sprintf("%s/language/fr-FR/fr-FR.plg_cgisotope_%s.sys.ini", JPATH_ADMINISTRATOR, $this->extname),
		];
